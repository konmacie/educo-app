 ...
 * Needs to override protected @method _log defining logging behavior.
 */
abstract class BaseLogger {
  /**
   * Defines threshold for logging, whether recieved log entry should be logged or not.
   */
  ...
  /**
   * Checks whether log entry meets level threshold and calls _log method.
   */
...
/**
 * Abstract base class for logger writing to Storage class object, eg. SessionStorage.
 * Extending class should assign intended Storage object to this._storage property.
 */
abstract class StorageLogger extends BaseLogger {
  ...
  /**
   * Retrieves logs with given label.
   */
